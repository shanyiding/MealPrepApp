...
class RootPage(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.fridge_btn = RoundedButton("My Fridge", bg_color=theme.BLUE, height=42)
        self.daily_btn = RoundedButton("Daily Tracker", bg_color=theme.CHIP_OFF, text_color=theme.MID, height=42)
        self.profile_btn = RoundedButton("Profile", bg_color=theme.CHIP_OFF, text_color=theme.MID, height=42)
